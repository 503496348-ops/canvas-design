#!/usr/bin/env python3
"""
从 Wikimedia Commons 抓真实图片（公共领域 / CC），供 canvas-design「内容型设计取真图」用（Phase 3.5）。
...
UA = "atomcollide-image-fetcher/1.0 (https://huasheng.ai; skill contact)"
...
def main():
    ap = argparse.ArgumentParser(description="Wikimedia Commons 真图抓取（canvas-design Phase 3.5）")
