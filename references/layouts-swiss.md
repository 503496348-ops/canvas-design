...
`/Users/guohao/Documents/503496348-ops的仓库/项目/Thin-Harness-Fat-Skills/ppt/index.html`
...
1. 同时打开三份页面:原始参考 PPT、当前 `template-swiss.html` 或生成页、正在修改的测试 PPT。原始参考路径是 `/Users/guohao/Documents/503496348-ops的仓库/项目/Thin-Harness-Fat-Skills/ppt/index.html`。
...
<div class="h-bar-chart">
  <div class="bar-row">
    <span class="bar-lbl">AI Advisor</span>
